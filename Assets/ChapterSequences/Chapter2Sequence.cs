...
public class Chapter2Sequence : Chapter
{
    ...
    private string[] getOpening()
    {
        ...
        int yellowModel = 1;
        int blueModel = 2;
        int pearlSilhouetteModel = 3;
        int pearlColorModel = 4;
        int yellowDone = 0;
        int yellowLeave = 1;
        int blueLeave = 2;
        int pearlDest = 3;
        ...
        return new string[]
        {
            ...
            "$rotateCharacter " + yellowModel + " " + pinkPos,
            "$rotateCharacter " + blueModel + " " + pinkPos,
            ...
            "$animate " + pinkModel + " Idle",
            "$animate " + yellowModel + " Talking",
            yellow + "Ugh. I'm done listening to you.",
            "$animate " + yellowModel + " Standard_Walk",
            "$moveCharacter " + yellowModel + " " + yellowDone + " 5",
            "$pause 1",
            "$animate " + yellowModel + " Idle",
            "$animate " + pinkModel + " Talking_2",
            ...
            "$animate " + pinkModel + " Talking",
            "$animate " + blueModel + " Idle",
            pink + "It's just--",
            "$animate " + pinkModel + " Idle",
            "$animate " + blueModel + " Talking",
            ...
            "$silence",
            "$animate " + blueModel + " Standard_Walk",
            "$animate " + yellowModel + " Standard_Walk",
            "$moveCharacter " + yellowModel + " " + yellowLeave + " 5",
            "$moveCharacter " + blueModel + " " + blueLeave + " 5",
            "$pause 5",
            "$sound diamond-music stop",

            "$animate " + pearlSilhouetteModel + " Standard_Walk",
            "$moveCharacter " + pearlSilhouetteModel + " " + pearlDest + " 1",
            "$pause 3",
            "$animate " + pearlSilhouetteModel + " Idle",
            "$rotateCharacter " + pearlSilhouetteModel + " " + pinkPos,
            "$pause 2",
            "$equip " + pearlSilhouetteModel + " Iron_Blade",
            "$equip " + pearlColorModel + " Iron_Blade",
            "$animate " + pearlSilhouetteModel + " Sword_Idle",
            "$animate " + pearlColorModel + " Sword_Idle",
            "$sound equip play",
            "$pause 2",

            "$teleportCharacter " + pearlColorModel + " " + pearlDest + " " + pinkPos,
            "$teleportCharacter " + pearlSilhouetteModel + " " + yellowLeave + " " + pinkPos,
            "$moveCharacter " + pearlSilhouetteModel + " " + yellowLeave + " 5", //to keep her from moving back
            "$rotateCharacter " + pinkModel + " " + pearlDest,
            "$animate " + pinkModel + " Talking",
